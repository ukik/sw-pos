...
export default {
  ...
  methods: {
    ...
    async openDialogAbsensi(item, title) {
      ...
      const isAbsensi = await this.getAbsensiShiftManual(item?.id);

      if (isAbsensi?.id) {
        // temp = this.struk;
        // temp["cashier"] = item;
        temp = isAbsensi;
        this.struk = isAbsensi;
      } else {
        this.addNewStruk();
        temp = this.struk;
      ...
      console.log("openDialogAbsensi temp", temp);
      console.log("openDialogAbsensi isAbsensi", isAbsensi);
      console.log("openDialogAbsensi struk", this.struk);
