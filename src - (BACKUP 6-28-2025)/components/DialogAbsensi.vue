...
export default {
  ...
  methods: {
    ...
    onOpen(payload, title) {
      // console.log("onOpen struk", this.struk);
      // console.log("onOpen payload", payload);
      // console.log("onOpen title", title);
      console.log("---------------------------------------");

      this.medium = true;
      this.title = title;
      // this.form = this.struk;
    ...
    async onSave() {
      console.log("onSave 1", this.form, this.cashier, this.mode);

      this.$refs.jenis_modal?.validate();
      this.$refs.shift?.validate();

      // if (this.mode !== "ABSENSI MASUK") return;
      ...
      if (this.mode == "ABSENSI MASUK") {
        ...
        this.addItemToStruk(); // tidak dimanfaatkan lagi
      } else {
        this.struk.catatan_pulang = this.form.catatan_pulang;
      }

      console.log("onSave", this.form, this.struk);
