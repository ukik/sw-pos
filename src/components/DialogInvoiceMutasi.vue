  ...
  methods: {
    ...
    makePDFShare() {
      var opts = {
        ...
        fileName: `INVOICE-MUTASI-${this.invoice?.cabang}-${this.invoice?.cashier}-SHIFT ${this.invoice?.shift}-${this.invoice?.created_at}.pdf`, //it will use this filename as a place-holder
      };
