...
export default {
  ...
  computed: {
    ...
    ...mapWritableState(usePengaturanStore, {
      rotasi_courir: "rotasi_courir",
      rotasi_cashier: "rotasi_cashier",
    }),
  ...
  watch: {
    rotasi_courir: {
      ...
      handler(val) {
        ...
        console.log("rotasi_courir", this.struk);
  ...
  methods: {
    ...
    onSubmit() {
      ...
      console.log(
        "this.rotasi_courir?.pin !== this.pin1",
        this.rotasi_courir?.pin,
        this.pin1
      );
      console.log(
        "this.rotasi_courir?.pin !== this.pin2",
        this.rotasi_cashier?.pin,
        this.pin2
      );
      if (this.rotasi_courir?.pin != this.pin1 || this.rotasi_cashier?.pin != this.pin2) {
        return this.$q.notify({
          message: "Peringatan",
