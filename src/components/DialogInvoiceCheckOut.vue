    ...
    createContent() {
      ...
      let content = `
                          ...
                          <html lang="en">
                              <head>
                                  <meta charset="utf-8">
                                  <title>INVOICE CHECK TUTUP</title>
  ...
  methods: {
    ...
    makePDFShare() {
      var opts = {
        ...
        fileName: `INVOICE-CHECK-TUTUP-${this.invoice?.cabang}-${this.invoice?.cashier}-SHIFT ${this.invoice?.shift}-${this.invoice?.created_at}.pdf`, //it will use this filename as a place-holder
      };
