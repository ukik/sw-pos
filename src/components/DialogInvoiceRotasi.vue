      ...
      >
        ...
        <table id="customers2">
          <tbody>
            ...
            <tr>
              <td>Kasir Pemberi</td>
              <td>{{ invoice?.cashier_pemberi?.nama }}</td>
              <td>Kasir Penerima</td>
              <td>{{ invoice?.cashier_penerima?.nama }}</td>
            </tr>
            <tr>
              <td>Konfirmasi Pemberi</td>
              <td>Kasir {{ $getSetuju(invoice?.cashier_1_confirm) }}</td>
              <td>Konfirmasi Penerima</td>
              <td>Kasir {{ $getSetuju(invoice?.cashier_2_confirm) }}</td>
            </tr>
